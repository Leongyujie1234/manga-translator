...
from pipeline import process_single, TRANSLATE_MODEL
...
def index():
    api_key = get_api_key()
    return render_template("index.html", has_key=bool(api_key), model=f"Local OCR + {TRANSLATE_MODEL}")
...
if __name__ == "__main__":
    ...
    if not key:
        ...
        print("Detect: Local (EasyOCR + Manga OCR)")
